...
type PositionDataXs = Omit<PositionData, 'feeX' | 'feeY' | 'rewardOne' | 'rewardTwo'>;
...
declare function fromStrategyParamstoWeightDistribution(activeId: number, strategyParameters: StrategyParameters): {
    binId: number;
    weight: number;
}[];
...
declare const unwrapSOLInstruction: (owner: PublicKey) => Promise<TransactionInstruction>;
...
declare class LBCLMM {
    ...
    static createMultiple(connection: Connection, clmmList: Array<PublicKey>, opt?: Opt): Promise<LBCLMM[]>;
    static getAllLbPairPositionsByUser(connection: Connection, userPubKey: PublicKey, opt?: Opt): Promise<Map<string, {
        publicKey: PublicKey;
        lbPair: LbPairAccount;
        tokenX: TokenReserve;
        tokenY: TokenReserve;
    ...
    static processPosition(program: ClmmProgram, version: PositionVersion, lbPair: LbPairAccount, positionAccount: PositionAccount, baseTokenDecimal: number, quoteTokenDecimal: number, lowerBinArray: BinArray, upperBinArray: BinArray): Promise<PositionData>;
    static getBinsBetweenLowerAndUpperBound(lbPair: LbPairAccount, lowerBinId: number, upperBinId: number, baseTokenDecimal: number, quoteTokenDecimal: number, lowerBinArrays: BinArray, upperBinArrays: BinArray): BinLiquidity[];
    static getPriceOfBinByBinId(binStep: number, binId: number): string;
    ...
    getBinArrays(): Promise<_coral_xyz_anchor.ProgramAccount<{
        index: BN;
        version: number;
        padding: number[];
        lbPair: PublicKey;
    ...
    initializePositionAndAddLiquidityByWeight({ positionPubKey, totalXAmount, totalYAmount, xYAmountDistribution, user, }: TInitializePositionAndAddLiquidityParams): Promise<Transaction | Transaction[]>;
    addLiquidityByWeight({ lbPairPubKey, positionPubKey, totalXAmount, totalYAmount, xYAmountDistribution, user, }: TInitializePositionAndAddLiquidityParams): Promise<Transaction | Transaction[]>;
    private processXYAmountDistribution;
    createBinArraysIfNeeded(lbPair: PublicKey, binArrayIndexes: BN[], funder: PublicKey): Promise<TransactionInstruction[]>;
     ...
     */
    getEqualWeightageAmount(lbPairPubKey: PublicKey, token: 'X' | 'Y', tokenAmount: BN): Promise<BN>;
     ...
     */
    swapQuote(inAmount: BN, swapForY: boolean, allowedSlippage: BN, binArrays: BinArrayAccount[]): {
        outAmount: BN;
        fee: BN;
        protocolFee: BN;
        minOutAmount: BN;
    ...
    static getClaimableLMReward(program: ClmmProgram, positionVersion: PositionVersion, lbPair: LbPairAccount, position: PositionAccount, lowerBinArray?: BinArray, upperBinArray?: BinArray): Promise<{
        rewardOne: BN;
        rewardTwo: BN;
    }>;
    ...
    static getClaimableSwapFee(program: ClmmProgram, positionVersion: PositionVersion, position: PositionAccount, lowerBinArray?: BinArray, upperBinArray?: BinArray): Promise<{
        feeX: BN;
        feeY: BN;
    }>;
...
export { ADMIN, BASIS_POINT_MAX, BIN_ARRAY_BITMAP_SIZE, Bin, BinAndAmount, BinArray, BinArrayAccount, BinArrayBitmapExtension, BinArrayBitmapExtensionAccount, BinLiquidity, BinLiquidityDistribution, BinLiquidityReduction, BitmapType, ClmmProgram, DLMMError, EXTENSION_BINARRAY_BITMAP_SIZE, FEE_PRECISION, FeeInfo, GetOrCreateATAResponse, IAccountsCache, LBCLMM, LBCLMM_PROGRAM_IDS, LbPairAccount, LbPairAccountsStruct, LiquidityOneSideParameter, LiquidityParameterByWeight, MAX_ACTIVE_BIN_SLIPPAGE, MAX_BIN_ARRAY_SIZE, MAX_BIN_LENGTH_ALLOWED_IN_ONE_TX, MAX_BIN_PER_POSITION, MAX_CLAIM_ALL_ALLOWED, MAX_FEE_RATE, Network, PRECISION, ParabolicParameter, PositionAccount, PositionBinData, PositionData, PositionDataXs, PositionVersion, SCALE, SCALE_OFFSET, SIMULATION_USER, SpotParameter, StrategyParameters, StrategyType, SwapParams, TInitializePositionAndAddLiquidityParams, TokenReserve, binIdToBinArrayIndex, calculateBidAskDistribution, calculateNormalDistribution, calculateSpotDistribution, chunkedFetchMultipleBinArrayBitmapExtensionAccount, chunkedFetchMultiplePoolAccount, chunkedGetMultipleAccountInfos, chunks, computeBudgetIx, computeFee, computeFeeFromAmount, computeProtocolFee, deriveBinArray, deriveBinArrayBitmapExtension, deriveLbPair, deriveOracle, derivePosition, derivePresetParameter, deriveReserve, findNextBinArrayIndexWithLiquidity, findNextBinArrayWithLiquidity, fromStrategyParamstoWeightDistribution, fromWeightDistributionToAmount, getBaseFee, getBinArrayLowerUpperBinId, getBinFromBinArray, getOrCreateATAInstruction, getOutAmount, getTokenBalance, getTokenDecimals, getTotalFee, getVariableFee, isBinIdWithinBinArray, isOverflowDefaultBinArrayBitmap, parabolicParameter, parseLogs, sParameters, spotParameter, swapQuoteAtBin, toStrategyParameters, toWeightDistribution, unwrapSOLInstruction, vParameters, wrapSOLInstruction };
