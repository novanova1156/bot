...
export declare class WhirlpoolIx {
    ...
    static setConfigFeatureFlagIx(program: Program<Whirlpool>, params: ix.SetConfigFeatureFlagParams): import("@orca-so/common-sdk").Instruction;
    ...
    static initializeAdaptiveFeeTierIx(program: Program<Whirlpool>, params: ix.InitializeAdaptiveFeeTierParams): import("@orca-so/common-sdk").Instruction;
    static initializePoolWithAdaptiveFeeIx(program: Program<Whirlpool>, params: ix.InitPoolWithAdaptiveFeeParams): import("@orca-so/common-sdk").Instruction;
    static setDefaultBaseFeeRateIx(program: Program<Whirlpool>, params: ix.SetDefaultBaseFeeRateParams): import("@orca-so/common-sdk").Instruction;
    static setDelegatedFeeAuthorityIx(program: Program<Whirlpool>, params: ix.SetDelegatedFeeAuthorityParams): import("@orca-so/common-sdk").Instruction;
    static setFeeRateByDelegatedFeeAuthorityIx(program: Program<Whirlpool>, params: ix.SetFeeRateByDelegatedFeeAuthorityParams): import("@orca-so/common-sdk").Instruction;
    static setInitializePoolAuthorityIx(program: Program<Whirlpool>, params: ix.SetInitializePoolAuthorityParams): import("@orca-so/common-sdk").Instruction;
    static setPresetAdaptiveFeeConstantsIx(program: Program<Whirlpool>, params: ix.SetPresetAdaptiveFeeConstantsParams): import("@orca-so/common-sdk").Instruction;
    static resetPositionRangeIx(program: Program<Whirlpool>, params: ix.ResetPositionRangeParams): import("@orca-so/common-sdk").Instruction;
    static lockPositionIx(program: Program<Whirlpool>, params: ix.LockPositionParams): import("@orca-so/common-sdk").Instruction;
    static transferLockedPositionIx(program: Program<Whirlpool>, params: ix.TransferLockedPositionParams): import("@orca-so/common-sdk").Instruction;
    ...
    static initDynamicTickArrayIx(program: Program<Whirlpool>, params: ix.InitDynamicTickArrayParams): import("@orca-so/common-sdk").Instruction;
    ...
    static setTokenBadgeAttributeIx(program: Program<Whirlpool>, params: ix.SetTokenBadgeAttributeParams): import("@orca-so/common-sdk").Instruction;
}
