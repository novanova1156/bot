...
import type { DecreaseLiquidityInput, IncreaseLiquidityInput, LockConfigData, LockTypeData, PositionData, TickData, WhirlpoolData } from "./types/public";
...
export interface Whirlpool {
    ...
    initTickArrayForTicks: (ticks: number[], funder?: Address, opts?: WhirlpoolAccountFetchOptions, tickArrayType?: "dynamic" | "fixed") => Promise<TransactionBuilder | null>;
...
export interface Position {
    ...
    resetPositionRange: (tickLowerIndex: number, tickUpperIndex: number, positionWallet?: Address) => Promise<TransactionBuilder>;
