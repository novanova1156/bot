...
let ParsableTickArray = class ParsableTickArray {
    static parse(address, accountData) {
        ...
        if (discriminator.equals(anchor_1.BorshAccountsCoder.accountDiscriminator(public_1.AccountName.DynamicTickArray))) {
            try {
        ...
        if (discriminator.equals(anchor_1.BorshAccountsCoder.accountDiscriminator(public_1.AccountName.TickArray))) {
            try {
