...
class WhirlpoolImpl {
    ...
    async initTickArrayForTicks(ticks, funder, opts = fetcher_1.IGNORE_CACHE, tickArrayType = "dynamic") {
        ...
        initTickArrayStartPdas.forEach((initTickArrayInfo) => {
            ...
            switch (tickArrayType) {
                case "dynamic":
                    instruction = (0, instructions_1.initDynamicTickArrayIx)(this.ctx.program, {
                    ...
                    break;
                case "fixed":
                    instruction = (0, instructions_1.initTickArrayIx)(this.ctx.program, {
                        startTick: initTickArrayInfo.startIndex,
                        tickArrayPda: initTickArrayInfo.pda,
                        whirlpool: this.address,
                        funder: !!funder
    ...
    async getOpenPositionWithOptMetadataTx(tickLower, tickUpper, liquidityInput, wallet, funder, tokenProgramId, withMetadata = false, positionMint) {
        ...
        (0, tiny_invariant_1.default)(tokenProgramId.equals(spl_token_1.TOKEN_PROGRAM_ID) ||
            tokenProgramId.equals(spl_token_1.TOKEN_2022_PROGRAM_ID), "tokenProgramId must be either TOKEN_PROGRAM_ID or TOKEN_2022_PROGRAM_ID");
    ...
    async getClosePositionIx(positionAddress, slippageTolerance, destinationWallet, positionWallet, payerKey, usePriceSlippage = false) {
        ...
        const rewardsToCollect = this.data.rewardInfos
            ...
            return ((rewardsQuote.rewardOwed[index] ?? common_sdk_1.ZERO).gtn(0) ||
                (rewardsQuote.transferFee.deductedFromRewardOwed[index] ?? common_sdk_1.ZERO).gtn(0));
        });
